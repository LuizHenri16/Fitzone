package fitzoneapp.Util.JCustom;
...
public final class customButton extends JButton implements MouseListener {

    public enum ButtonStyle {
        //Estilos dos botões

        DEFAULT(new Color(243, 243, 243), new Color(233, 233, 233), new Color(244, 255, 255)),
